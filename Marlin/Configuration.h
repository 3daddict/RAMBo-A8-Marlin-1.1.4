 ...
 */
#define BAUDRATE 115200 //RAMBo default baud
...
#define CUSTOM_MACHINE_NAME "RAMBo A8"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100.05, 99.97, 400.41, 105.5 } //{ 100, 100, 400, 95 }
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER 0  //17.5   // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER 0  //52.5   // Y offset: -front +behind [the nozzle]
...
// If the servo can't reach the requested positiocn, increase it.
